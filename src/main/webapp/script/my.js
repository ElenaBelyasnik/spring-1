...
function edit_task(task_id){
    ...
    let seve_tag = "<button id='save_" + task_id + "'>Save</button>";
    $(identifier_edit).html(seve_tag);
    ...
    let td_decription = children[1];
    td_decription.innerHTML = "<input id='input_description_'" + task_id + "' type='text' value='" + td_decription.innerHTML + "'>";
